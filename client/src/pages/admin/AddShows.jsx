    ...
    <>
              ...
              <div className='relative rounded-lg overflow-hidden'>
                ...
                p-2 bg-black/70 w-full absolute bottom-0 left-0'>
                  <p className='flex items-center gap-1 text-gray-400'>
                    ...
                    fill-primary'/>{movie.vote_average.toFixed(1)}
                  </p>
        ...
        <div className='mt-6'>
          ...
          p-1 pl-3 rounded-lg'>
            ...
            <button onClick={handleDateTimeAdd} className='bg-primary/60
            text-white px-3 py-2 text-sm rounded-lg
                ...
                <li key={date}>
                  ...
                  <div className='flex flex-wrap gap-2 mt-1 text-sm'>
                    {times.map((time) => (
                      ...
                      py-1 flex items-center rounded' key={time}>
                        <span>{time}</span>
        ...
        hover:bg-primary/60 transition-all cursor-pointer'>Add Show</button>
